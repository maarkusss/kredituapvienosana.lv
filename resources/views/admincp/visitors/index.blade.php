...
@section('title', 'Visitors - ' . env('APP_NAME'))
        ...
        <div class="flex flex-row flex-1 h-full">
            ...
            <div class="flex flex-col items-start justify-start w-full min-h-full p-4 bg-transparent">
                <div class="flex flex-col justify-between w-full mb-4 sm:flex-row">
                    <h1 class="text-2xl font-medium text-gray-700">Visitors</h1>
                    <div>
                        <form>
                            <label>
                                <input
                                    ...
                                    name="search" type="text" value="{{ request()->search }}" placeholder="Search">
                            </label>
                        </form>
                    </div>
                </div>
                <div class="w-full p-4 bg-white rounded">
                    <div class="overflow-x-auto whitespace-no-wrap ">
                        <table class="w-full overflow-x-scroll text-gray-700 whitespace-no-wrap table-auto">
                            <thead>
                                <tr class="border-b">
                                    <th class="p-3 text-sm text-gray-700">Visitor ID</th>
                                    <th class="p-3 text-sm text-gray-700">Clicks</th>
                                    <th class="p-3 text-sm text-gray-700">Time</th>
                                    <th class="p-3 text-sm text-gray-700">Device</th>
                                    <th class="p-3 text-sm text-gray-700">Country</th>
                                    <th class="p-3 text-sm text-gray-700">Came from</th>
                                    <th class="p-3 text-sm text-gray-700">Went to</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr class="bg-blue-100 border-b hover:bg-blue-200">
                                        <td class="p-2 text-center">
                                            <a class="underline hover:text-primary-normal"
                                                href="{{ route('admincp.visitors.visitor', ['visitor_id' => $visitor->id]) }}"
                                                target="_blank">
                                                {{ $visitor->id }}
                                            </a>
                                        </td>
                                        <td class="p-2 text-center">
                                            <span>{{ $visitor->clicks }}</span>
                                        </td>
                                        <td class="p-2 text-center">
                                            <span>{{ date(' d/m/Y H:i:s', strtotime($visitor->created_at)) }}</span>
                                        </td>
                                        <td class="p-2 text-center">
                                            <div class="flex justify-center">
                                                @if ($agent->isMobile($visitor->user_agent))
                                                    <a href="#"
                                                        ...
                                                        <svg class="w-5 h-5 text-gray-700 fill-current">
                                                            <path
                                                                d="M10.592 13.575l-.125-.1a.629.629 0 0 0-.15-.075l-.15-.067a.834.834 0 0 0-.759.225.958.958 0 0 0-.175.275.834.834 0 0 0 1.084 1.092c.1-.048.192-.11.275-.183a.832.832 0 0 0 0-1.167zm2.741-11.908H6.667a2.5 2.5 0 0 0-2.5 2.5v11.666a2.5 2.5 0 0 0 2.5 2.5h6.666a2.5 2.5 0 0 0 2.5-2.5V4.167a2.5 2.5 0 0 0-2.5-2.5zm.834 14.166a.834.834 0 0 1-.834.834H6.667a.833.833 0 0 1-.834-.834V4.167a.833.833 0 0 1 .834-.834h6.666a.833.833 0 0 1 .834.834v11.666z" />
                                                        </svg>
                                                    </a>
                                                @elseif($agent->isTablet($visitor->user_agent))
                                                    <a href="#"
                                                        ...
                                                        <svg class="w-5 h-5 text-gray-700 fill-current">
                                                            <path
                                                                d="M14.167 1.667H5.833a2.5 2.5 0 0 0-2.5 2.5v11.666a2.5 2.5 0 0 0 2.5 2.5h8.334a2.5 2.5 0 0 0 2.5-2.5V4.167a2.5 2.5 0 0 0-2.5-2.5zM15 15.833a.834.834 0 0 1-.833.834H5.833A.833.833 0 0 1 5 15.833V4.167a.833.833 0 0 1 .833-.834h8.334a.833.833 0 0 1 .833.834v11.666zm-4.408-2.258a.833.833 0 0 0-.759-.242l-.15.05a.637.637 0 0 0-.15.075l-.125.1a.834.834 0 0 0-.175.275.833.833 0 0 0 .175.909c.083.073.176.135.275.183a.834.834 0 0 0 1.15-.758.7.7 0 0 0-.066-.317.958.958 0 0 0-.175-.275z" />
                                                        </svg>
                                                    </a>
                                                @else
                                                    <a href="#"
                                                ...
                                                @elseif($agent->isAndroidOS($visitor->user_agent))
                                                    <svg class="w-5 h-5 ml-1" viewBox="0 0 576 512">
                                                        <path fill="currentColor"
                                                ...
                                                @if ($agent->is('Firefox', $visitor->user_agent))
                                                    <svg class="w-5 h-5 ml-1" viewBox="0 0 512 512">
                                                        <path fill="currentColor"
                                                ...
                                                @elseif($agent->is('Chrome', $visitor->user_agent))
                                                    <svg class="w-5 h-5 ml-1" viewBox="0 0 496 512">
                                                        <path fill="currentColor"
                                        ...
                                        <td class="p-2 text-center">
                                            @if ($visitor->country !== 'ZZ')
                                                <a href="#"
                                                    onclick="prompt('IP','{{ $visitor->ip }}');return false;">
                                                    <img width="20" height="15" class="mx-auto"
                                                        src="https://dev.goodday.group/flags/4x3/{{ strtolower($visitor->country) }}.svg">
                                                </a>
                                            @else
                                                <a href="#"
                                                    onclick="prompt('IP','{{ $visitor->ip }}');return false;">
                                        ...
                                        <td class="p-2 text-center">
                                            @if ($visitor->from)
                                                <a class="underline hover:text-primary-normal" href="{{ $visitor->from }}"
                                                    target="_blank">
                                                    {{ $visitor->from }}
                                                </a>
                                            @else
                                                <svg class="w-5 mx-auto text-red-400" viewBox="0 0 512 512">
                                                    <path fill="currentColor"
                                        ...
                                        <td class="p-2 text-center">
                                            @if ($visitor->to)
                                                <a class="underline hover:text-primary-normal" href="{{ $visitor->to }}"
                                                    target="_blank">
                                                    {{ $visitor->to }}
                                                </a>
                                            @else
                    ...
                    {{ $visitors->links('admincp.components.pagination') }}
                </div>
            </div>
        </div>
    </div>
