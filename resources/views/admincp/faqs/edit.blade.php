        ...
        <div class="flex flex-row flex-auto h-full">
            ...
            <div class="flex flex-col items-start justify-start w-full min-h-full p-4 bg-transparent">
                ...
                <div class="w-full p-4 bg-white rounded">
                    ...
                    <form action="{{ route('admincp.faqs.update', ['faq' => $faq->id]) }}" method="POST"
                        ...
                        <div class="relative flex w-full mt-2 mb-6">
                            <textarea
                                ...
                                id="auto_expand" name="question" placeholder="Faq's question" maxlength="1000" required>{{ $faq->question }}</textarea>
                        </div>
                        ...
                        <div class="flex w-full mt-2 mb-6">
                            <label class="w-full">
                                <textarea class="w-full p-2 border-gray-300 rounded-lg resize-y" name="answer" placeholder="Faq's answer"
                                    maxlength="1000" id="answer" required>{!! $faq->answer !!}</textarea>
                            </label>
                            <script>
                        ...
                        <div class="flex w-full mt-2 mb-6">
                            <label class="w-full">
                                <textarea class="w-full p-2 border-gray-300 rounded-lg resize-y" name="topic" id="topic">{!! $faq->topic !!}</textarea>
                            </label>
                            <script>
                                    ...
                                    @forelse($sections as $section)
                                        <label class="flex items-center mx-2 my-1 text-gray-800 text-normal">
                                            <input
                                                ...
                                                @if ($section->faq($faq->id) == 'true') checked @endif>
                                            {{ $section->name }}
                                        </label>
                                    @empty
                                        <label class="flex items-center mx-2 my-1 text-gray-800 text-normal">
                                    ...
                                    @forelse($sectionTags as $sectionTag)
                                        <label class="flex items-center mx-2 my-1 text-gray-800 text-normal">
                                            <input
                                                ...
                                                @if ($sectionTag->faq($faq->id) == 'true') checked @endif>
                                            {{ $sectionTag->name }}
                                        </label>
                                    @empty
                                        <label class="flex items-center mx-2 my-1 text-gray-800 text-normal">
                                    ...
                                    @forelse($loanTypes as $loanType)
                                        <label class="flex items-center mx-2 my-1 text-gray-800 text-normal">
                                            <input
                                                ...
                                                @if ($loanType->faq($faq->id) == 'true') checked @endif>
                                            {{ $loanType->name }}
                                        </label>
                                    @empty
                                        <label class="flex items-center mx-2 my-1 text-gray-800 text-normal">
                    ...
                    @can('delete faq')
                        <form action="{{ route('admincp.faqs.destroy', ['faq' => $faq->id]) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <button
                                class="flex flex-row items-center px-3 py-2 mt-2 ml-auto text-sm font-medium text-white transition-colors duration-200 bg-red-600 rounded hover:bg-red-700"
